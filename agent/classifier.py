...
if __name__ == "__main__":
    ...
    # Test case 1: Python dependency error
    test_log_1 = """
    ...
    job_info_1 = {"job_name": "test-job", "stage": "test"}
    result_1 = classifier.classify_error(test_log_1, job_info_1)
    print("Test 1 - Dependency Error:")
    print(f"  Type: {result_1['error_type']}")
    print(f"  Package: {result_1['package_name']}")
    print(f"  Language: {result_1['language']}")
    print()
    ...
    result_2 = classifier.classify_error(test_log_2, job_info_1)
    print("Test 2 - Syntax Error:")
    print(f"  Type: {result_2['error_type']}")
    print(f"  File: {result_2['error_file']}")
    print(f"  Line: {result_2['error_line']}")
    print()

    # Test case 3: Test failure
    test_log_3 = """
    FAILED tests/test_api.py::test_user_creation - AssertionError: Expected 201 but got 400
    """

    result_3 = classifier.classify_error(test_log_3, job_info_1)
    print("Test 3 - Test Failure:")
    print(f"  Type: {result_3['error_type']}")
    print(f"  Message: {result_3['error_message']}")
    print()
