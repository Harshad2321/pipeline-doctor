...
if __name__ == "__main__":
    ...
    reporter = Reporter(reports_dir="test_reports")
    ...
    test_report = reporter.generate_report(
        ...
        job_info={
            ...
            "job_name": "test-job",
            "stage": "test",
            "web_url": "https://gitlab.com/job/67890"
        },
        error_info={
        ...
        fix_result={
            "success": True,
            "fix_applied": "Added numpy to requirements.txt",
        ...
        pipeline_result={
            "pipeline_id": "12346",
            "status": "success",
            "web_url": "https://gitlab.com/pipeline/12346",
    ...
    print(f"Test report generated: {test_report}")
    ...
    test_stats = {
        ...
        "escalated": 5,
        "common_errors": [
            {"error_type": "dependency", "count": 10},
            {"error_type": "syntax", "count": 8},
            {"error_type": "test", "count": 5},
            {"error_type": "config", "count": 2}
        ]
    }

    reporter.print_stats(test_stats)
